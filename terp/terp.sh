...
echo " ██║ ╚████║╚██████╔╝██████╔╝███████╗██╔╝ ██╗    ╚██████╗██║  ██║██║     ██║   ██║   ██║  ██║███████╗";
echo " ╚═╝  ╚═══╝ ╚═════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝     ╚═════╝╚═╝  ╚═╝╚═╝     ╚═╝   ╚═╝   ╚═╝  ╚═╝╚══════╝";
echo ">>> Cosmovisor Automatic Installer for Terp Network | Chain ID : morocco-1 <<<";
echo -e "\e[0m"
...
GENESIS=https://snap.nodexcapital.com/terp/genesis.json
ADDRBOOK=https://snap.nodexcapital.com/terp/addrbook.json
PORT=116
...
# Set peers and seeds
PEERS="$(curl -sS https://terp-mainnet-rpc.itrocket.net/net_info | jq -r '.result.peers[] | "\(.node_info.id)@\(.remote_ip):\(.node_info.listen_addr)"' | awk -F ':' '{print $1":"$(NF)}' | sed -z 's|\n|,|g;s|.$||')"
SEEDS="d8256642afae77264bcce1631d51233a9d00249b@terp-mainnet-seed.itrocket.net:13656,c71e63b5da517984d55d36d00dc0dc2413d0ce03@seed.terp.network:26656"
